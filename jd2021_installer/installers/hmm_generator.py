...
def _generate_zone_a(
    ...
    for i in range(zone_a_count):
        ...
        # We explicitly force edge_group_type = 0 (Pure Position) to ensure static JDNext poses don't fail velocity checks.
        # We explicitly set padding to 0, matching official Ubisoft gestures.
        records.extend(struct.pack('<5i', state_id, flag, joint_id, 0, 0))
        state_id += 1
